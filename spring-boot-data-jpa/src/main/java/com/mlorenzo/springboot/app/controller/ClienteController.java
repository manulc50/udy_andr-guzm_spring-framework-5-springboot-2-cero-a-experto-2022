...
public class ClienteController {
	...
	// Escucha peticiones http de tipo GET para la ruta '/form/' + id_cliente
	...
	public String guardar(@Valid Cliente cliente, BindingResult result,Model model,SessionStatus status,RedirectAttributes flash){
		...
		// Creamos el atributo "success" de tipo Flash con el mensaje de éxtio creado en el paso anterior.Es de tipo Flash ya que a continuación devolvemos un redirect a '/listar'.Entonces,no vamos directamente a la vista '/listar',sino que volvemos a lanzar una segunda petición http al método handler "listar" asociado a la ruta '/listar' y queremos mantener este atributo para esta segunda petición http

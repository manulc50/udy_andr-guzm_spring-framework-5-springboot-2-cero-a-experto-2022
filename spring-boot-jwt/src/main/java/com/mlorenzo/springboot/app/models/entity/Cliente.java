...
public class Cliente implements Serializable{ 
	...
	@NotNull(message="no puede estar vacío") //  Validación(no es una restricción a nivel de campo de tabla) de la propiedad createAt para que no sea nula.La anotación @NotEmpty no funcionaría aquí porque es para propiedades String 
